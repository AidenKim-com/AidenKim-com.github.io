...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		{
			name: "GitHub",
			url: "https://github.com/AidenKim-com", // Internal links should not include the base path, as it is automatically added
	...
	links: [
		{
			...
			url: "https://x.com/44441d3n",
		},
		{
			name: "GitHub",
			icon: "fa6-brands:github",
			url: "https://github.com/AidenKim-com",
		},
	],
};
